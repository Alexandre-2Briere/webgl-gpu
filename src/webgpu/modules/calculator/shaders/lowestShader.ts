// WGSL compute shader: applies a fixed rebate rate and CAD→EUR conversion to
// each price. Both parameters are passed via a uniform buffer so the same
// compiled pipeline can be reused across different rates without recompilation.
export const LOWEST_COMPUTE_SHADER = /* wgsl */`
