 ...
 */
export function buildCubeVertices(color: [number, number, number, number]): { vertices: Float32Array; indices: Uint32Array } {
  ...
  const indices  = new Uint32Array(FACE_COUNT * 6)
