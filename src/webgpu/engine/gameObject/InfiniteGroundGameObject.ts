import type { ISceneObject } from './GameObject';
import { Rigidbody3D } from './rigidbody/Rigidbody3D';
import { PlaneHitbox } from './hitbox/PlaneHitbox';
import { InfiniteGroundRenderable } from './renderables/InfiniteGroundRenderable';
